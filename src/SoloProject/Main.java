...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			// TODO: Use meaningful variable names. Refactor -> Rename
			// TODO: Maybe try using IntelliJ Community Edition
				...
				while (condition) {
					...
					try {
						...
						case 0:
							...
							String sql = "CREATE TABLE Shops (" + "Shop_Name VARCHAR(255) PRIMARY KEY,"
									+ "Email varchar(255) not null," + "Tel int, " + "Fax VARCHAR(255), "
									+ "Website VARCHAR(255));"

									+ "CREATE TABLE Items(" + "Product_id INT PRIMARY KEY,"
									+ "Product_Name VARCHAR(255)," + "Product_Price DECIMAL(10,2));"

									+ " CREATE TABLE Invoices (" + "Invoice_No INT PRIMARY KEY,"
									+ "Coustmer_Name VARCHAR(255)," + "Phone_Number INT," + "Invoice_Date VARCHAR(255),"
									+ "NoOf_items INT, " + "Product_id INT Foreign KEY REFERENCES Items(Product_id),"
									+ "Product_Name VARCHAR(255)," + "Product_Price DECIMAL(10,2) NOT NULL,"
									+ "Total_Price DECIMAL(10,2) ," + "Paid_Amount DECIMAL(10,2) ,"
							...
							while (condition1) {
								...
								case 2:
									...
									try {
										...
										String sql1 = "insert into Shops(Shop_Name, Tel, Fax, Email, Website) values('"
												+ shopName + "','" + telNo + "','" + faxNo + "','" + email + "','"
												+ website + "')";
						...
						case 2:
							...
							while (condition2) {
								...
								case 3:
									...
									String ch = "UPDATE Items SET Product_Price = " + productPrice
											+ " WHERE Product_id = " + change;
						...
						case 3:
							try {
								...
								invoiceInstance.setInvoiceDate(invoiceDate);
								...
								invoiceInstance.obj1.setQuantity(quantity);
								...
								String sql3 = "insert into Invoices(Invoice_No, Coustmer_Name, Phone_Number, Invoice_Date, NoOf_items, Product_id, Product_Name, Product_Price,"
										+ "Total_Price, Paid_Amount, Balance )" + "values('" + invoiceNo + "','"
										+ customerName + "','" + phoneNumber + "','" + invoiceDate + "','"
										+ numberOfItems + "','" + productId + "','" + productName + "','" + productPrice
